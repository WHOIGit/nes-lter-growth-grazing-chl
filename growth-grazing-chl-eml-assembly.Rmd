...
## QA: Consistency Across Replicates

Determine if there are differences across the two light treatments for each of the cruises. Slight differences in time observed for cruise EN608. There was one row missing which was expected: There was no 15% light experiment at EN617 station L10.
...
# Map Check
map_locs(growgraze_EDI, longitude, latitude, region = "transect", color.by = cruise)
